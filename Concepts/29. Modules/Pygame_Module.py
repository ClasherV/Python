...
"""
O/p: pygame 2.6.0 (SDL 2.28.4, Python 3.12.4)
     ...
     CLASSES
         ...
         class BufferError(builtins.BufferError)
          ...
          |
          |  __new__(*args, **kwargs) class method of builtins.BufferError
     ...
     DATA
         ...
         SDL = SDLVersion(major=2, minor=28, patch=4)
         SHOWN = 64
         SRCALPHA = 65536
         SRCCOLORKEY = 4096
         SWSURFACE = 0
         ...
         rev = ''
         ver = '2.6.0'
         vernum = PygameVersion(major=2, minor=6, patch=0)
     
     VERSION
         2.6.0
     
     FILE
         d:\programming\python\python\interpreter\lib\site-packages\pygame\__init__.py
